...
if plot_pow_map:
    ...
    beta = np.load("data/glm_pow_copes.npy")[0]
    pvalues = np.load("data/glm_pow_pvalues.npy")[0]
...
if plot_coh_net:
    ...
    beta = np.load("data/glm_coh_copes.npy")[0]
    pvalues = np.load("data/glm_coh_pvalues.npy")[0]
...
if plot_coh_map:
    ...
    beta = np.load("data/glm_mean_coh_copes.npy")[0]
    pvalues = np.load("data/glm_mean_coh_pvalues.npy")[0]
...
if plot_trans_prob:
    p = np.load("data/glm_tp_copes.npy")[0]
    pvalues = np.load("data/glm_tp_pvalues.npy")[0]
...
if plot_sum_stats:
    copes = np.load("data/glm_sum_stats_copes.npy")[0]
    pvalues = np.load("data/glm_sum_stats_pvalues.npy")[0]

    age = np.load("data/glm_age.npy")
    sum_stats = np.load("data/glm_sum_stats.npy")
