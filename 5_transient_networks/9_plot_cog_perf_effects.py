...
if plot_trans_prob:
    p = np.load("data/glm_tp_copes.npy")[1]
    pvalues = np.load("data/glm_tp_pvalues.npy")[1]
...
if plot_sum_stats:
    copes = np.load("data/glm_sum_stats_copes.npy")[1]
    pvalues = np.load("data/glm_sum_stats_pvalues.npy")[1]
