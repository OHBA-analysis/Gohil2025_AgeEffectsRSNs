...
# Load confound data
confound_ids = np.load("../3_design_matrix/data/id.npy")
age = np.load("../3_design_matrix/data/age.npy")
cog = np.load("../3_design_matrix/data/cog.npy")
sex = np.load("../3_design_matrix/data/sex.npy")
brain_vol = np.load("../3_design_matrix/data/brain_vol.npy")
gm_vol = np.load("../3_design_matrix/data/gm_vol.npy")
wm_vol = np.load("../3_design_matrix/data/wm_vol.npy")
headsize = np.load("../3_design_matrix/data/headsize.npy")
x = np.load("../3_design_matrix/data/x.npy")
y = np.load("../3_design_matrix/data/y.npy")
z = np.load("../3_design_matrix/data/z.npy")
