...
if plot_aec_net:
    ...
    beta = np.load("data/glm_aec_copes.npy")[0]
    pvalues = np.load("data/glm_aec_pvalues.npy")[0]
...
if plot_aec_map:
    ...
    beta = np.load("data/glm_mean_aec_copes.npy")[0]
    pvalues = np.load("data/glm_mean_aec_pvalues.npy")[0]
