...
part_csv = pd.read_csv(f"{base_dir}/3_design_matrix/data/all_collated_camcan.csv")
cog_csv = pd.read_csv(f"{base_dir}/2_cognitive_score/data/cognitive_metrics_pca.csv")
